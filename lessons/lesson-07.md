...
This is the base tutorial for the optional [Real-Time Audio Visualizer](../Assignments/assignment-3.md) bonus project. See [lesson-061](./lesson-061.md) for the circle/trigonometry math used to arrange the frequency bars radially.
